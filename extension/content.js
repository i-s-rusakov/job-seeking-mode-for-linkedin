        ...
        highlightTextNodes(postNode) {
            const walker = document.createTreeWalker(postNode, 4, {
                acceptNode: (node) => {
                    ...
                    if (parent.classList && (parent.classList.contains('ljsm-highlight') || parent.classList.contains('livf-highlight') || parent.classList.contains('ljsm-collapse-btn'))) return 2;
                    return 1;
                }
            });
